...
const TEMPLATES = [
  {
    ...
    category: "Frameworks",
    theme: "Modern Dark",
    prompt: "Create a 12-slide Series A pitch deck using the Sequoia structure. Focus on market size, traction, and our ask.",
  ...
  },
  {
    ...
    category: "Aesthetics",
    theme: "Cyber Dark",
    prompt: "Create a presentation with a Cyber-dark theme, neon accents, and deep black backgrounds.",
  ...
  },
  {
    ...
    description: "A high-conversion B2B sales deck focusing on ROI, competitor comparison, and case studies.",
    category: "Frameworks",
    theme: "Corporate Blue",
    prompt: "Build an Enterprise B2B sales deck. Include competitor matrix, ROI calculation, and 2 case studies.",
  ...
  {
    id: "data-to-deck",
    title: "URL to Pitch Deck",
    description: "Paste your website link and let our AI extract the copy to build your company profile deck.",
    category: "AI Powers",
    theme: "Dynamic",
    prompt: "Generate a company profile presentation based on the following website URL: [Paste URL here]",
  ...
  },
  {
    ...
    description: "High contrast, massive typography, very clean. The ultimate investor-grade aesthetic.",
    category: "Aesthetics",
    theme: "Minimal Light",
    prompt: "Use a Swiss minimalist aesthetic with massive typography, black and white contrast, and a grid layout.",
  ...
  },
  {
    ...
    description: "A 3-minute, high-impact structure designed for fast angel investor pitches.",
    category: "Frameworks",
    theme: "Startup Bold",
    prompt: "Build a Y-Combinator Demo Day pitch deck. Max 5 slides, huge text, single metric focus.",
...
export default function TemplatesPage() {
  ...
  const handleUseTemplate = (prompt: string) => {
    ...
    router.push(`/editor?prompt=${encodedPrompt}&mode=create`);
  };
          ...
          <AnimatePresence mode="popLayout">
            {filteredTemplates.map((template, index) => {
              ...
              return (
                ...
                >
                  {/* Top Preview Area */}
                  <div className={`relative h-48 rounded-[1.5rem] bg-gradient-to-br ${template.color} flex flex-col items-center justify-center p-6 overflow-hidden`}>
                    ...
                    >
                      <Icon className={`w-8 h-8 ${template.textColor || 'text-white'}`} strokeWidth={1.5} />
                    </motion.div>
                    
                    <div className={`text-center relative z-10 ${template.textColor || 'text-white'}`}>
