...
export function IconTriangle(props: OrbsteraIconProps) {
  return (
    <OrbsteraIcon viewBox="0 0 24 24" {...props}>
<g id="warning-triangle--frame-alert-warning-triangle-exclamation-caution">
    <path id="Vector" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M7.89003 1.0499C7.80611 0.886097 7.67861 0.748632 7.52158 0.652642 7.36455 0.556651 7.18407 0.505859 7.00003 0.505859c-0.18405 0 -0.36453 0.050792 -0.52156 0.146783 -0.15703 0.09599 -0.28453 0.233455 -0.36844 0.397258l-5.500004 11c-0.07671 0.1522 -0.113232 0.3215 -0.106098 0.4919 0.007134 0.1703 0.057688 0.3359 0.146861 0.4812 0.089172 0.1453 0.214003 0.2654 0.362641 0.3488 0.14863 0.0835 0.31613 0.1276 0.4866 0.1281H12.5c0.1705 -0.0005 0.338 -0.0446 0.4866 -0.1281 0.1487 -0.0834 0.2735 -0.2035 0.3627 -0.3488 0.0891 -0.1453 0.1397 -0.3109 0.1468 -0.4812 0.0072 -0.1704 -0.0294 -0.3397 -0.1061 -0.4919l-5.49997 -11Z" strokeWidth={props.strokeWidth || 1.5}></path>
    <path id="Vector_2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M7 5v3.25" strokeWidth={props.strokeWidth || 1.5}></path>
    <g id="Group 2605">
      <path id="Ellipse 1111" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M7 11c-0.13807 0 -0.25 -0.1119 -0.25 -0.25s0.11193 -0.25 0.25 -0.25" strokeWidth={props.strokeWidth || 1.5}></path>
      <path id="Ellipse 1112" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M7 11c0.13807 0 0.25 -0.1119 0.25 -0.25s-0.11193 -0.25 -0.25 -0.25" strokeWidth={props.strokeWidth || 1.5}></path>
    </g>
  </g>
    </OrbsteraIcon>
  );
