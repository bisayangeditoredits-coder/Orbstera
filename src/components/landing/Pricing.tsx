...
const tiers = [
  {
    ...
    features: [
      { text: '~150 credits/month (~1–2 AI decks)', included: true },
      { text: 'Up to 6 slides per presentation', included: true },
      { text: 'Automatic cinematic layout & motion', included: true },
      { text: 'PPTX export with watermark', included: true },
      { text: 'AI Magic Edit — 15 uses (text edits)', included: true },
      { text: 'Generative Fill — 8 uses (FLUX AI)', included: true },
      { text: 'Voice Protocol (Hands-free generation)', included: true },
      { text: 'Longer decks (25+ slides)', included: false },
      { text: 'Watermark-free export', included: false },
    ],
    href: '/login',
    popular: false,
    planId: 'free',
  },
  {
    ...
    features: [
      { text: '500 credits/month — ~6 full AI decks with images', included: true },
      { text: 'Up to 25 slides per presentation', included: true },
      { text: 'GPT-5.5 + Claude Sonnet orchestration', included: true },
      { text: 'Generative Fill with FLUX Kontext Pro (unlimited)', included: true },
      { text: 'PPTX export — no watermark', included: true },
      { text: 'All premium templates & themes', included: true },
      { text: 'AI Magic Edit — unlimited inline editing', included: true },
      { text: 'Cinematic FLUX imagery for every slide', included: true },
  ...
  {
    name: 'Creator Pro',
    prices: { USD: '$22', PHP: '₱1,250' },
    period: '/month',
    description: 'Built for agencies, teachers & power users who live and breathe presentations.',
    badge: 'Best Value',
    icon: "/3d_icons/Trophy.png",
    features: [
      { text: '1,125 credits/month — ~14 full AI decks with images', included: true },
      { text: 'Up to 40 slides per presentation', included: true },
      { text: 'GPT-5.5 + Claude Opus 4 maximum intelligence', included: true },
      { text: 'Generative Fill with FLUX Kontext Max (best quality)', included: true },
      { text: 'PPTX export — no watermark, custom branding', included: true },
      { text: 'All templates + cinematic FLUX Ultra imagery', included: true },
      { text: 'AI Magic Edit — unlimited, highest quality', included: true },
