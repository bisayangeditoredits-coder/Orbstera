...
const REVIEWS = [
  ...
  },
  {
    ...
    body: "I never thought I'd care about presentations. But seeing what Orbstera generated from my rough bullet points made me actually excited to present to stakeholders.",
    rating: 5,
...
const MarqueeRow = ({ items, direction = "left", speed = 40 }: { items: typeof REVIEWS, direction?: "left" | "right", speed?: number }) => {
  ...
  return (
    <div className="flex w-full overflow-hidden">
      ...
      `}</style>
      <div className={`flex gap-6 pr-6 w-max ${dirClass}`}>
  ...
  return (
    <section className="relative w-full py-32 overflow-hidden bg-[#FAFAFA] border-y border-black/[0.04]">
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 mb-20 text-center flex flex-col items-center">
        ...
        <p className="text-slate-500 text-lg md:text-xl max-w-2xl text-balance font-medium">
