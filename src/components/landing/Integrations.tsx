    ...
    <section className="w-full py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-neutral-900 tracking-tighter mb-6">
          ...
          <p className="text-neutral-500 text-lg md:text-xl max-w-2xl mx-auto font-medium tracking-tight">
        ...
        {/* Bottom Feature Bar */}
        <div className="mt-20 p-8 rounded-[2.5rem] bg-gradient-to-b from-neutral-50 to-white border border-black/[0.05] shadow-[0_1px_2px_rgba(0,0,0,0.02)] flex flex-col md:flex-row items-center justify-between gap-8">
